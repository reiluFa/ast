...
class Game:
    ...
    def load_resources(self):
        self.playerShip_image = pyglet.image.load('Assetss/PNG/playerShip1_orange.png')
        set_anchor_of_image_to_center(self.playerShip_image)
        self.background_image = pyglet.image.load('Assetss/Backgrounds/black.png')

        self.asteroid_brown_big = pyglet.image.load('Assetss/PNG/Meteors/meteorBrown_big4.png')
        self.asteroid_brown_med = pyglet.image.load('Assetss/PNG/Meteors/meteorBrown_med3.png')
